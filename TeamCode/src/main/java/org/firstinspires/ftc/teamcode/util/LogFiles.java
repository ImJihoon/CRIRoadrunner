...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = AutonMechDrive.TRANSLATIONAL_PID.kP;
        public double mecTransI = AutonMechDrive.TRANSLATIONAL_PID.kI;
        public double mecTransD = AutonMechDrive.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = AutonMechDrive.HEADING_PID.kP;
        public double mecHeadingI = AutonMechDrive.HEADING_PID.kI;
        public double mecHeadingD = AutonMechDrive.HEADING_PID.kD;
        public double mecLateralMultiplier = AutonMechDrive.LATERAL_MULTIPLIER;
